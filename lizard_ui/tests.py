...
class TestUtility(TestCase):
    ...
    def test_short_timedelta(self):
        self.assertEqual(u'4 dagen', short_timedelta(
                datetime.timedelta(days=4)))
        self.assertEqual(u'1 dag', short_timedelta(
                datetime.timedelta(days=1, seconds=5)))
        self.assertEqual(u'1 dag', short_timedelta(
                datetime.timedelta(days=1)))
        self.assertEqual(u'5 uur', short_timedelta(
                datetime.timedelta(seconds=3600 * 5 + 300)))
        self.assertEqual(u'5 uur', short_timedelta(
                datetime.timedelta(seconds=3600 * 5)))
        self.assertEqual(u'5 minuten', short_timedelta(
                datetime.timedelta(seconds=60 * 5 + 4)))
        self.assertEqual(u'5 minuten', short_timedelta(
                datetime.timedelta(seconds=60 * 5)))
        self.assertEqual(u'36 seconde', short_timedelta(
...
class TestApplicationIcon(TestCase):
    ...
    def test_url1(self):
        ...
        self.assertEqual('/static_media/reinout.png',
                         ai.icon_url())

    def test_url2(self):
        ai = ApplicationIcon(icon='lizard_ui/reinout.png')
        self.assertEqual('/static_media/lizard_ui/reinout.png',
                         ai.icon_url())
    ...
    def test_url4(self):
        ...
        self.assertEqual('http://example.org/reinout.png',
                         ai.icon_url())
