...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ApplicationScreen.description'
        db.add_column('lizard_ui_applicationscreen', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ApplicationScreen.description'
        db.delete_column('lizard_ui_applicationscreen', 'description')
