...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb, cb2) {
        ...
        this.opens = 'right';
        this.cb = function () { };
        this.cb2 = function () { }; // by erikjan.vos@nelen-schuurmans.nl
        ...
        if (hasOptions) {
            ...
            if (typeof options.initialRangeType == 'string')
                this.currentRangeType = options.initialRangeType;
            ...
            if (typeof options.ranges == 'object') {
                for (var range in options.ranges) {
                    ...
                    var range_type = options.ranges[range][2];
                    ...
                    this.ranges[range] = [start, end, range_type];
                }

                var list = '<ul>';
                for (var range in this.ranges) {
                    list += '<li data-range-type="' + this.ranges[range][2] + '">' + range + '</li>';
                }
                // by erikjan.vos@nelen-schuurmans.nl
                /*
                list += '<li data-range-type="custom">' + this.locale.customRangeLabel + '</li>';
                this.ranges[this.locale.customRangeLabel] = [null, null, 'custom'];
                */
                /*
    ...
    DateRangePicker.prototype = {
        ...
        notify: function () {
            ...
            // by erikjan.vos@nelen-schuurmans.nl
            var val = this.startDate.toString(this.format) + ' - ' + this.endDate.toString(this.format);
            if (this.element.is('input')) {
        ...
        show: function (e) {
            this.updateFromControl(); // by erikjan.vos@nelen-schuurmans.nl
            this.container.show();
            this.move();
        ...
        clickRange: function (e) {
            // by erikjan.vos@nelen-schuurmans.nl
            var label = e.target.innerHTML;
            var range = this.ranges[label];
            this.currentRangeType = range[2];
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            var theDateFormatted = this.locale.monthNames[theDate.getMonth()] + ' ' + theDate.getFullYear();
    ...
    $.fn.daterangepicker = function (options, cb, cb2) {
      this.each(function() {
        var el = $(this);
        if (!el.data('daterangepicker'))
          el.data('daterangepicker', new DateRangePicker(el, options, cb, cb2));
      });
      return this;
    };
